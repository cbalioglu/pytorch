...
PyObject *THPModule_suspend_allocators(PyObject *_unused, PyObject *noargs)
{
  at::globalContext().suspendAllocators();
  Py_RETURN_NONE;
}

PyObject *THPModule_restore_allocators(PyObject *_unused, PyObject *noargs)
{
  at::globalContext().restoreAllocators();
  Py_RETURN_NONE;
}
...
static PyMethodDef TorchMethods[] = {
  ...
  {"_suspend_allocators", THPModule_suspend_allocators, METH_NOARGS, nullptr},
  {"_restore_allocators", THPModule_restore_allocators, METH_NOARGS, nullptr},
